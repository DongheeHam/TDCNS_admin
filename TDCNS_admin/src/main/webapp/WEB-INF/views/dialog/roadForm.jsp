...
<div class="modal-header">
	<h5 class="modal-title" id="exampleModalLabel">진입로 등록</h5>
...
<div class="modal-body">
		<form>
			<div class="form-group">
				...
				<input type="text" class="form-control road-ino" id="road-ino" aria-describedby="emailHelp" placeholder="교차로번호를 입력하세요.">
				<small id="road-ino-help" class="form-text text-muted">진입로가 소속된 교차로의 고유번호를 입력하세요.</small>
			</div>
			<div class="form-group">
				<label for="road-name">진입로 이름</label>
				<input type="text" class="form-control road-name" id="road-name" placeholder="진입로명을 입력하세요.">
			</div>
			<div class="form-group">
				<label for="road-ip">IP</label>
				<input type="text" class="form-control road-ip" id="road-ip" placeholder="모듈 ip를 입력하세요.">
			</div>
			<div class="form-group">
				<label for="road-stream">스트리밍URL</label>
				<input type="text" class="form-control road-stream" id="road-stream" placeholder="스트리밍 URL을 입력하세요.">
			</div>
			<div class="form-group">
				<label for="exampleInputPassword1">좌표를 입력하세요</label>
				<div class=" d-flex flex-row">
					<input type="text" class="form-control mr-1 road-lat" placeholder="위도">
					<input type="text" class="form-control ml-1 road-lng" placeholder="경도">
				</div>
			</div>
...
$(document).ready(function() {
	setTimeout(function(){
		var roadFormMap=new KakaoMap('road-form-map',{search:true});
